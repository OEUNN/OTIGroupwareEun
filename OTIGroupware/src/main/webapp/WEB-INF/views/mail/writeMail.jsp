								...
								<div class="card-body">
									...
									<form class="forms-sample">
										<div class="container-fluid row"><!-- 버튼 container -->
											...
											<button class="col-5 col-lg-1 btn btn-info mr-2 my-2">임시 저장</button>
											<button type="submit" class="col-5 col-lg-1 btn btn-primary my-2">Submit</button>
										</div>
										<div class="form-group row">
											<label class="col-1 pt-3" for="sendMail">
												발신인
											</label> 
											<input type="text" class="form-control col-5" id="sendMail" style="border:none;border-bottom:1px solid #ced4da;">
										</div>
										<div class="form-group row">
											<label class="col-1 pt-3" for="recivedMail">수신인
											</label>
											<input type="text" class="form-control col" id="recivedMail" style="border:none;border-bottom:1px solid #ced4da;">
											<label class="col-2 pt-3" for="recivedMail">
												<button class="ml-2 btn btn-sm btn-inverse-primary" onclick="address()">주소록</button>
											</label>
										</div>
										<div class="form-group row" >
											<label class="col-1 pt-3" for="title"> 제목
												<img src="${pageContext.request.contextPath}/resources/images/starfull.png" style="width:20px; height:20px"></img>
											</label>
											<input type="text" class="form-control col-9" id="title" style="border:none;border-bottom:1px solid #ced4da;">
										</div>
										<div class="form-group" >
											<label>File upload
												<button class="file-upload-browse btn btn-inverse-primary btn-sm ml-2" type="button">Upload</button>
											</label> 
