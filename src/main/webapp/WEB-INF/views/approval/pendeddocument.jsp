		        			...
		        			<div class="card-body">
			        			...
			        			<div class="card-body">
		        					<div class="row py-0" style="padding: 1.25rem;">
		        						...
		        						<div class="col-6">
		        							<div class="d-flex">
		        								<form class="d-flex" action="<c:url value="/approval/pendeddocument/search"></c:url>">
								...
								<div class="table-responsive">
									<table class="table">
										<thead>
											<tr>
												<th class="px-0 pl-0  pb-2 border-bottom">문서 번호</th>
												<th class="px-0 border-bottom pb-2">결재상태</th>
